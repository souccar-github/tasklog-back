...
namespace TaskLog.Migrations
{
    ...
    [Migration("20230704104139_InitialBasicClasses")]
    partial class InitialBasicClasses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskLog.TaskManagement.DailyWorks.DailyWork", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskLog.TaskManagement.Tasks.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskLog.TaskManagement.TaskTypes.TaskType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TaskLog.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TaskLog.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("TaskLog.TaskManagement.DailyWorks.DailyWork", b =>
                {
                    b.HasOne("TaskLog.TaskManagement.Projects.Project", "Project")
                        .WithMany()
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TaskLog.TaskManagement.TaskTypes.TaskType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskLog.TaskManagement.Tasks.Task", b =>
                {
                    b.HasOne("TaskLog.Authorization.Users.User", "AssignedTo")
                        .WithMany()
