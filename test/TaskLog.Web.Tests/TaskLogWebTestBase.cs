...
{
    public abstract class TaskLogWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TaskLogWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TaskLogWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TaskLogDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TaskLogDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TaskLogDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TaskLogDbContext, Task<T>> func)
        {
            T result;
